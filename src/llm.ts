...
// These are the Chinese-optimized defaults for the fork.
// Resolution order remains: YAML config > env var > built-in default.
const DEFAULT_EMBED_MODEL = "hf:gpustack/bge-m3-GGUF/bge-m3-Q8_0.gguf";
